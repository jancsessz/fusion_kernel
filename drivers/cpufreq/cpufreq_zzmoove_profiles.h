...
#define PROFILE_MAX_FREQ (1998000)	// ZZ: max possible freq in system table for freq adaption (possible OC frequencies inclusive)
...
struct zzmoove_profile zzmoove_profiles[] = {
	{
		...
		2,		// inputboost_typingbooster_cores (0=disable, range from 1 to MAX_CORES)
#endif /* ENABLE_INPUTBOOSTER */
#ifdef ENABLE_MUSIC_LIMITS
		1458000,	// music_max_freq (0=disable, range from 0 to freq->max in khz)
		384000,		// music_min_freq (0=disable, range from 0 to freq->min in khz)
...
#endif /* (MAX_CORES == 8) */
		1026000,	// up_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1458000,	// up_threshold_hotplug_freq2
	...
	},
	{
		...
		55,		// down_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		810000,		// down_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		...
		0,		// scaling_block_threshold
		2,		// scaling_block_force_down
		1728000,	// scaling_fastdown_freq
		95,		// scaling_fastdown_up_threshold
		90,		// scaling_fastdown_down_threshold
		702000,		// scaling_responsiveness_freq
		20,		// scaling_responsiveness_up_threshold
		1,		// scaling_proportional
#ifdef ENABLE_INPUTBOOSTER
		0,		// inputboost_cycles
	...
	},
	{
		...
		55,		// down_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		594000,		// down_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		...
		68,		// up_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		810000,		// up_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
	...
	},
	{
		...
		55,		// down_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		486000,		// down_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		...
		68,		// up_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		486000,		// up_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
	...
	},
	{
		...
		95,		// scaling_fastdown_up_threshold
		90,		// scaling_fastdown_down_threshold
		486000,		// scaling_responsiveness_freq
	...
	},
	{
		...
		68,		// up_threshold_hotplug7
#endif /* (MAX_CORES == 8) */
		702000,		// up_threshold_hotplug_freq1
#if (MAX_CORES == 4 || MAX_CORES == 6 || MAX_CORES == 8)
		1267200,	// up_threshold_hotplug_freq2
	...
	},
	{
		...
		95,		// scaling_fastdown_up_threshold
		90,		// scaling_fastdown_down_threshold
		594000,		// scaling_responsiveness_freq
		20,		// scaling_responsiveness_up_threshold
		1,		// scaling_proportional
#ifdef ENABLE_INPUTBOOSTER
		0,		// inputboost_cycles
